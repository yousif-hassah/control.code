...
-- 1. Remove any duplicate profiles (keep the oldest one for each email)
...
-- ============================================
-- PHASE 7: ENABLE REALTIME FOR ALL GROUP TABLES
-- ============================================

-- 13. Enable realtime for all group-related tables
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS public.group_messages;
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS public.group_tasks;
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS public.group_members;
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS public.group_activities;
...
-- ============================================
-- PHASE 8: ENSURE RLS IS DISABLED FOR TESTING
...
-- ============================================
-- PHASE 9: CREATE HELPER FUNCTION FOR MEMBER LEADERBOARD
-- ============================================

-- 14. Function to get top performers in a group
...
FROM pg_indexes 
WHERE tablename IN ('profiles', 'group_tasks', 'group_messages', 'group_activities', 'group_members');

-- Check if view exists
SELECT * FROM information_schema.views WHERE table_name = 'group_member_stats';
